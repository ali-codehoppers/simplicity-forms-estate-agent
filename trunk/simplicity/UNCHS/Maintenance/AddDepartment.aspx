...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <div style="background-color: White; padding: 15px 10px 25px 10px; min-height: 350px;">
        ...
        <div class="text_field" style="padding-bottom: 5px;">
            ...
            <asp:TextBox ID="txtDeptDescription" runat="server" Rows="5" CssClass="text_area"
                TextMode="MultiLine" Style="width: 300px"></asp:TextBox>
            <asp:RequiredFieldValidator runat="server" ID="reqDeptDescription" ControlToValidate="txtDeptDescription" ErrorMessage="*" Display="Dynamic"></asp:RequiredFieldValidator>
